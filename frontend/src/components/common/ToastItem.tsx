...
const ToastItem: React.FC<ToastItemProps> = ({ toast, onClose }) => {
  ...
  return (
    <div className={`max-w-sm w-full shadow-large rounded-lg pointer-events-auto border ${getToastStyles()} transform transition-all duration-300 ease-in-out`}>
      <div className="p-4">
        <div className="flex items-start">
          ...
          <div className="ml-4 flex-shrink-0 flex">
            <button
              ...
              className="inline-flex text-neutral-400 hover:text-neutral-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary-500 rounded transition-colors"
            >
